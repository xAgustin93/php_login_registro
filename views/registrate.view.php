        ...
        <div class="row">
            ...
            <div class="col-12">
                <form id="form-registro" class="form-inline" actio="<?php echo htmlspecialchars($_SERVER['PHP_SELF'])?>" method="POST" name="login">
                    ...
                    <label class="sr-only" for="usuario">Repetir contraseña</label>
                    <div class="input-group col-12 form-section">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                                <i class="fas fa-lock"></i>
                        ...
                        <input type="password" class="form-control" id="formRepeatpassword" placeholder="Repetir contraseña" name="password2">
